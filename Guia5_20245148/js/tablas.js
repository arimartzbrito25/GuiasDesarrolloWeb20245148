...
const alumnos = [
    ...
    { id: 3, nombre: "Ana Paola", apellido: "Quintanilla Peña", correo: "alexis.quintanilla@estudiante.esen.edu.sv" },
    { id: 4, nombre: "Vanesa Alejandra", apellido: "Bermudez Urquilla", correo: "vanessa.bermudez@estudiante.esen.edu.sv" },
...
alumnos.forEach(alumno => {
    table += "<tr>";
    table += `<th scope='row'>${alumno.id}</td>`;
