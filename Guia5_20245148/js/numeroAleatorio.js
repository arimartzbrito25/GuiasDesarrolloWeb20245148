...
function generarNumeroAleatorio() {
    ...
    if (intentos <= numeroIntentos) {
        ...
        if (numero == numeroAleatorio) {
            ...
            // Aquí agregamos la pista si el número es más alto o más bajo
            let pista = numero < numeroAleatorio 
                ? "El número a adivinar es más alto" 
                : "El número a adivinar es más bajo";
            
            mensaje = `${pista}. Vuelve a intentar. Quedan ${
